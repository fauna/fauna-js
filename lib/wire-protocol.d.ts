...
export declare const isQuerySuccess: <T>(res: any) => res is QuerySuccess<T>;
export declare const isQueryFailure: (res: any) => res is QueryFailure;
export declare const isQueryResponse: (
  res: any
) => res is QueryFailure | QuerySuccess<any>;
/**
 * Any error handled by this driver.
 */
export declare class FaunaError extends Error {
