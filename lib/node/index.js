...
var require_https_agent = __commonJS({
  "node_modules/agentkeepalive/lib/https_agent.js"(exports2, module2) {
    ...
    HttpsAgent2.prototype[CREATE_HTTPS_CONNECTION] = OriginalHttpsAgent.prototype.createConnection;
    [
      "getName",
      "_getSession",
      "_cacheSession",
...
var _lastTxn, _getSecret, getSecret_fn, _query, query_fn, _getError, getError_fn, _setHeaders, setHeaders_fn;
var Client = class {
  constructor(clientConfiguration) {
    ...
    this.client.defaults.httpAgent = new import_agentkeepalive.default(agentSettings);
    this.client.defaults.httpsAgent = new import_agentkeepalive.HttpsAgent(agentSettings);
    this.client.defaults.headers.common["Authorization"] = `Bearer ${this.clientConfiguration.secret}`;
    this.client.defaults.headers.common["Content-Type"] = "application/json";
    __privateMethod(this, _setHeaders, setHeaders_fn).call(this, this.clientConfiguration, this.client.defaults.headers.common);
  }
  async query(request, headers) {
    if ("query" in request) {
      return __privateMethod(this, _query, query_fn).call(this, { ...request, ...headers });
    }
...
query_fn = async function(queryRequest) {
  ...
  const headers = {};
  __privateMethod(this, _setHeaders, setHeaders_fn).call(this, queryRequest, headers);
  try {
    ...
    if (__privateGet(this, _lastTxn) === void 0 && result.data.txn_time !== void 0 || result.data.txn_time !== void 0 && __privateGet(this, _lastTxn) !== void 0 && __privateGet(this, _lastTxn) < txnDate) {
...
getError_fn = function(e) {
  ...
  if (e.request?.status === 0 || e.request?.socket?.connecting || nodeOrAxiosNetworkErrorCodes.includes(e.code) || "Network Error" === e.message) {
...
setHeaders_fn = function(fromObject, headerObject) {
  ...
  if (headerObject["x-last-txn"] === void 0 && __privateGet(this, _lastTxn) !== void 0) {
