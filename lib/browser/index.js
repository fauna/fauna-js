...
var G = { max_conns: 10, endpoint: I.cloud, timeout_ms: 6e4, fetch: M },
  ...
  L = class {
    ...
    async query(e, r) {
      return "query" in e
        ? i(this, k, j).call(this, { ...e, ...r })
        : i(this, k, j).call(this, e.toQuery(r));
    }
  };
(y = new WeakMap()),
  (C = new WeakSet()),
  ...
  (j = async function (e) {
    ...
    try {
      ...
      let p = await this.clientConfiguration.fetch(o, {
          method: "POST",
          headers: c,
          body: JSON.stringify({ query: r, arguments: t }),
          keepalive: !0,
        }),
        F = p.body;
  ...
  b = class {
    constructor(e) {
      ...
      if ("queryFragments" in e) {
        ...
        q(this, l, { ...e, queryArgs: i((r = b), _, B).call(r, e.queryArgs) });
      } else q(this, l, e);
    }
    static create(e, ...r) {
      var t;
