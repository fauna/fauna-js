  ...
  "node_modules/depd/lib/compat/index.js"(exports2, module2) {
    ...
    lazyProperty(
      ...
      function callSiteToString2() {
        ...
        return stack2[0].toString ? toString3 : require_callsite_tostring();
      }
    );
    lazyProperty(
      module2.exports,
...
var require_https_agent = __commonJS({
  "node_modules/agentkeepalive/lib/https_agent.js"(exports2, module2) {
    ...
    var { INIT_SOCKET, CREATE_HTTPS_CONNECTION } = require_constants();
    var HttpsAgent2 = class extends HttpAgent {
      constructor(options) {
        super(options);
    ...
    HttpsAgent2.prototype[CREATE_HTTPS_CONNECTION] =
      OriginalHttpsAgent.prototype.createConnection;
    ["getName", "_getSession", "_cacheSession", "_evictSession"].forEach(
      function (method) {
        if (typeof OriginalHttpsAgent.prototype[method] === "function") {
          HttpsAgent2.prototype[method] = OriginalHttpsAgent.prototype[method];
        }
      }
    );
    module2.exports = HttpsAgent2;
  },
});
...
var require_combined_stream = __commonJS({
  "node_modules/combined-stream/lib/combined_stream.js"(exports2, module2) {
    ...
    CombinedStream.isStreamLike = function (stream3) {
      return (
        typeof stream3 !== "function" &&
        typeof stream3 !== "string" &&
        typeof stream3 !== "boolean" &&
        typeof stream3 !== "number" &&
        !Buffer.isBuffer(stream3)
      );
    };
  ...
  "node_modules/form-data/lib/form_data.js"(exports2, module2) {
    ...
    FormData4.prototype._trackLength = function (header, value, options) {
      ...
      this._overheadLength +=
        Buffer.byteLength(header) + FormData4.LINE_BREAK.length;
      if (
        !value ||
        (!value.path &&
...
function buildURL(url2, params, options) {
  ...
  const serializerParams = utils_default.isURLSearchParams(params)
    ? params.toString()
...
function httpAdapter(config) {
  return new Promise(function dispatchHttpRequest(
    ...
    req = transport.request(options, function handleResponse(res) {
      ...
      responseStream =
        streams.length > 1
          ? import_stream2.default.pipeline(streams, utils_default.noop)
          : streams[0];
      const offListeners = import_stream2.default.finished(
        responseStream,
        () => {
          offListeners();
          onFinished();
...
var adapters_default = {
  getAdapter: (nameOrAdapter) => {
    if (utils_default.isString(nameOrAdapter)) {
      ...
      if (!nameOrAdapter) {
        throw Error(
          utils_default.hasOwnProp(nameOrAdapter)
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== "undefined") {
    ...
    typeof process !== "undefined" &&
    utils_default.kindOf(process) === "process"
  ) {
...
var Axios = class {
  ...
  request(configOrUrl, config) {
    ...
    const defaultHeaders =
      config.headers &&
      utils_default.merge(config.headers.common, config.headers[config.method]);
    defaultHeaders &&
      utils_default.forEach(
...
var Client = class {
  constructor(clientConfiguration) {
    ...
    const timeout = this.clientConfiguration.timeout_ms + 1e4;
    const agentSettings = {
    ...
    this.client = axios_default2.create({
      baseURL: this.clientConfiguration.endpoint.toString(),
      timeout,
    });
    this.client.defaults.httpAgent = new import_agentkeepalive.default(
      agentSettings
    );
    this.client.defaults.httpsAgent = new import_agentkeepalive.HttpsAgent(
      agentSettings
    );
...
getSecret_fn = function (partialClientConfig) {
  const maybeSecret =
    partialClientConfig?.secret || import_process.env["FAUNA_SECRET"];
  if (maybeSecret === void 0) {
    throw new Error(
      "You must provide a secret to the driver. Set it in an environmental variable names FAUNA_SECRET or pass it to the Client constructor."
    );
  }
  return maybeSecret;
};
...
query_fn = async function (queryRequest) {
  const { query, arguments: args2 } = queryRequest;
  const headers = {};
  __privateMethod(this, _setHeaders, setHeaders_fn).call(
    this,
    queryRequest,
...
getServiceError_fn = function (error, httpStatus) {
  if (httpStatus === 401) {
  ...
  if (httpStatus === 400 && error.failures !== void 0) {
...
render_fn = function (nextArg = 0) {
  if ("queryFragments" in __privateGet(this, _queryInterpolation)) {
    ...
    localArgs.forEach((arg, i) => {
      ...
      args2 = { ...args2, ...argArguments };
    });
    return { query: renderedQuery.join(""), arguments: args2 };
  } else {
    const argName = `arg${nextArg}`;
    const args2 = {};
    args2[argName] = __privateGet(this, _queryInterpolation).json;
    return {
      query: `${argName}`,
      arguments: args2,
    };
