  ...
  if ((t && typeof t == "object") || typeof t == "function")
    for (let s of Bt(t))
      !jt.call(e, s) &&
        ...
        We(e, s, {
          get: () => t[s],
          enumerable: !(n = kt(t, s)) || n.enumerable,
        });
  return e;
};
var $e = (e, t, r) => (
...
var ie = (e, t, r) => (
    ge(e, t, "read from private field"), r ? r.call(e) : t.get(e)
  ),
  ae = (e, t, r) => {
    if (t.has(e))
  ...
  Te = (e, t, r, n) => (
    ge(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r
  );
var ue = (e, t, r) => (ge(e, t, "access private method"), r);
var Ye = Ke((qr, Oe) => {
  Oe.exports = Xe;
...
function xr(e, t, r) {
  ...
  function p(f, y, _) {
    ...
    if (f && !_ && typeof f == "object") {
      if (a.endsWith(y, "{}"))
        ...
        return (
          (y = ft(y)),
          b.forEach(function (be, Qt) {
            !a.isUndefined(be) &&
              t.append(
                o === !0 ? lt([y], Qt, i) : o === null ? y : y + "[]",
                u(be)
              );
          }),
          !1
    ...
    return Fe(f) ? !0 : (t.append(lt(_, y, i), u(f)), !1);
  }
  let E = [],
    h = Object.assign(yr, {
      defaultVisitor: p,
  ...
  function m(f, y) {
    if (!a.isUndefined(f)) {
      ...
      E.push(f),
        a.forEach(f, function (b, H) {
          (!a.isUndefined(b) &&
            s.call(t, b, a.isString(H) ? H.trim() : H, y, h)) === !0 &&
            m(b, y ? y.concat(H) : [H]);
        }),
        E.pop();
    }
...
function X(e, t, r) {
  ...
  n !== -1 && (e = e.slice(0, n));
  let s = (r && r.encode) || Sr,
    i = a.isURLSearchParams(t) ? t.toString() : new pe(t, r).toString(s);
...
var ht = typeof URLSearchParams < "u" ? URLSearchParams : pe;
var yt = FormData;
var wr = (() => {
    let e;
...
function Y(e, t) {
  return e && !Le(t) ? ke(e, t) : t;
}
var xt = x.isStandardBrowserEnv
  ? (function () {
...
a.inherits(St, d, { __CANCEL__: !0 });
var O = St;
function Be(e) {
  let t = /^([-+\w]{1,25})(:?\/\/|:)/.exec(e);
  return (t && t[1]) || "";
}
var Tr = a.toObjectSet([
    "age",
    "authorization",
    "content-length",
    "content-type",
...
Object.assign(M.prototype, {
  ...
  delete: function (e, t) {
    ...
    function s(i) {
      if (((i = Z(i)), i)) {
        let o = G(r, i);
        o && (!t || bt(r, r[o], o, t)) && (delete r[o], (n = !0));
      }
    }
  ...
  toJSON: function () {
    ...
    return (
      a.forEach(Object.assign({}, this[gt] || null, this), (t, r) => {
...
function ee(e) {
  return new Promise(function (r, n) {
    ...
    a.isFormData(s) && x.isStandardBrowserEnv && i.setContentType(!1);
    ...
    let p = Y(e.baseURL, e.url);
    u.open(e.method.toUpperCase(), X(p, e.params, e.paramsSerializer), !0),
      (u.timeout = e.timeout);
    function E() {
      if (!u) return;
      let m = R.from("getAllResponseHeaders" in u && u.getAllResponseHeaders()),
        y = {
          data:
    ...
    s === void 0 && i.setContentType(null),
      ...
      (e.cancelToken || e.signal) &&
        ((c = (m) => {
          !u ||
            (n(!m || m.type ? new O(null, e, u) : m), u.abort(), (u = null));
        }),
    ...
    function (t, r) {
      ...
      if (i) {
        if (n.indexOf("application/x-www-form-urlencoded") > -1)
          return Ue(t, this.formSerializer).toString();
...
function A(e, t) {
  ...
  let r = {};
  function n(u, p) {
    return a.isPlainObject(u) && a.isPlainObject(p)
      ? a.merge(u, p)
      : a.isPlainObject(p)
      ? a.merge({}, p)
      : a.isArray(p)
  ...
  return (
    a.forEach(Object.keys(e).concat(Object.keys(t)), function (p) {
      let E = l[p] || s,
        h = E(p);
      (a.isUndefined(h) && E !== c) || (r[p] = h);
    }),
    r
  );
}
...
var Ie = { assertOptions: Dr, validators: He };
var z = Ie.validators,
  v = class {
    constructor(t) {
      (this.defaults = t),
    ...
    request(t, r) {
      ...
      for (u = 0, p = c.length; u < p; ) l = l.then(c[u++], c[u++]);
      return l;
    }
    getUri(t) {
      t = A(this.defaults, t);
...
var Ur = { max_conns: 10, endpoint: Ve.cloud, timeout_ms: 6e4 },
  ze = class {
    #e;
    client;
    #t;
    constructor(t) {
      this.#e = { ...Ur, ...t, secret: this.#o(t) };
      let r = this.#e.timeout_ms + 1e4,
        n = {
          maxSockets: this.#e.max_conns,
          maxFreeSockets: this.#e.max_conns,
          timeout: r,
          freeSocketTimeout: 4e3,
          keepAlive: !0,
        };
      (this.client = Pt.create({
        baseURL: this.#e.endpoint.toString(),
        timeout: r,
      })),
        (this.client.defaults.httpAgent = new Se.default(n)),
        (this.client.defaults.httpsAgent = new Se.HttpsAgent(n)),
        (this.client.defaults.headers.common["Content-Type"] =
          "application/json"),
        (this.client.defaults.headers.common["X-Format"] = "simple"),
        this.#n(this.#e, this.client.defaults.headers.common);
    }
    get endpoint() {
      return this.#e.endpoint;
    }
    async query(t, r) {
      return "query" in t ? this.#r({ ...t, ...r }) : this.#r(t.toQuery(r));
    }
    #s(t) {
      if (t.response) {
        if (Dt(t.response.data)) {
          let r = t.response.data,
            n = t.response.status;
          return this.#i(r, n);
        }
        return new j({ message: t.message, httpStatus: t.response.status });
      }
      return t.request?.status === 0 ||
        t.request?.socket?.connecting ||
        Lr.includes(t.code) ||
        t.message === "Network Error"
        ? new q("The network connection encountered a problem.", { cause: t })
        : new B("A client level error occurred. Fauna was not called.", {
            cause: t,
          });
    }
    #o(t) {
    ...
    #i(t, r) {
      switch (r) {
        case 400:
          return r === 400 && Qr.includes(t.error.code)
            ? new F(t, r)
            : new C(t, r);
        case 401:
          return new D(t, r);
    ...
    async #r(t) {
      let { query: r, arguments: n } = t,
        s = { Authorization: `Bearer ${this.#e.secret}` };
      this.#n(t, s);
      try {
        ...
        return (
          ((this.#t === void 0 && i.data.txn_time !== void 0) ||
    ...
    #n(t, r) {
      ...
      r["x-last-txn"] === void 0 &&
        this.#t !== void 0 &&
        (r["x-last-txn"] = this.#t.toISOString());
    }
  },
  Qr = [
...
var N,
  ...
  W = class {
    ...
    toQuery(t = {}, r = 0) {
      return { ...ue(this, Re, Ut).call(this, r), ...t };
    }
  },
  we = W;
(N = new WeakMap()),
  ...
  (Ut = function (t = 0) {
    if ("queryFragments" in ie(this, N)) {
      ...
      return (
        n.forEach((c, l) => {
          let { query: u, arguments: p } = c.toQuery({}, t);
          p !== void 0 && (t += Object.keys(p).length);
          let E = r[l + 1];
...
export {
  ...
  U as AuthorizationError,
  ze as Client,
  B as ClientError,
  q as NetworkError,
  j as ProtocolError,
  F as QueryCheckError,
  C as QueryRuntimeError,
  P as QueryTimeoutError,
  S as ServiceError,
  L as ServiceInternalError,
  k as ServiceTimeoutError,
  Q as ThrottlingError,
  Ve as endpoints,
  kr as fql,
};
