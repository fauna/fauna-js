...
var Client = class {
  ...
  async #query(queryRequest) {
    ...
    try {
      ...
      if (this.#lastTxn === void 0 && result.data.txn_time !== void 0 || result.data.txn_time !== void 0 && this.#lastTxn !== void 0 && this.#lastTxn < txnDate) {
