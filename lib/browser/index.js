...
var A = Rr;
function ft(e) {
>>>>>>> 1420658 ([ENG-4040] Move to a single error type for the JS driver)
  let t = {
    "!": "%21",
    "'": "%27",
    "(": "%28",
...
function Y(e) {
  return new Promise(function (r, n) {
    ...
    let p = $(e.baseURL, e.url);
    u.open(e.method.toUpperCase(), K(p, e.params, e.paramsSerializer), !0),
      (u.timeout = e.timeout);
    function E() {
      if (!u) return;
      let m = S.from("getAllResponseHeaders" in u && u.getAllResponseHeaders()),
        y = {
          data:
...
=======
            (n(!m || m.type ? new N(null, e, u) : m), u.abort(), (u = null));
>>>>>>> 1420658 ([ENG-4040] Move to a single error type for the JS driver)
        }),
...
=======
          return A(c ? { "files[]": t } : t, l && new l(), this.formSerializer);
>>>>>>> 1420658 ([ENG-4040] Move to a single error type for the JS driver)
        }
      }
  ...
  transformResponse: [
    function (t) {
      let r = this.transitional || pe.transitional,
...
=======
      C(n || {}, { method: t, url: r, data: (n || {}).data })
>>>>>>> 1420658 ([ENG-4040] Move to a single error type for the JS driver)
    );
  };
});
...
=======
      return (O(this, _) === void 0 || O(this, _) < o) && V(this, _, o), i.data;
>>>>>>> 1420658 ([ENG-4040] Move to a single error type for the JS driver)
    } catch (i) {
  ...
  (Dt = function (t) {
    return t.response
      ? t.response.data?.error
        ? new D({ httpStatus: t.response.status, ...t.response.data.error })
        : new B({ message: t.message, httpStatus: t.response.status })
      : t.request?.status === 0 ||
        t.request?.socket?.connecting ||
        Lr.includes(t.code) ||
        t.message === "Network Error"
...
=======
      O(this, _) !== void 0 &&
      (r["x-last-txn"] = O(this, _).toISOString());
>>>>>>> 1420658 ([ENG-4040] Move to a single error type for the JS driver)
  });
var Lr = [
  "ECONNABORTED",
...
(P = new WeakMap()),
  ...
  (xe = new WeakSet()),
  (Ut = function (t = 0) {
    if ("queryFragments" in O(this, P)) {
      let { queryFragments: r, queryArgs: n } = O(this, P),
        s = r[0];
      ...
      let r = `arg${t}`,
        n = {};
      return (n[r] = O(this, P).json), { query: `${r}`, arguments: n };
    }
  }),
  g(Re, se);
export {
