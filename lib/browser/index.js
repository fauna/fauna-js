...
(N = new WeakMap()),
  ...
  (le = new WeakSet()),
  (Ge = async function (t) {
    let { query: r, arguments: n, format: s } = t,
      i = {};
    R(this, fe, Ze).call(this, t, i);
    try {
      let o = await this.client.post(
          "/query/1",
          { query: r, arguments: n, format: s },
          { headers: i }
        ),
        c = new Date(o.data.txn_time);
      return (
        ((O(this, N) === void 0 && o.data.txn_time !== void 0) ||
          (o.data.txn_time !== void 0 &&
            O(this, N) !== void 0 &&
            O(this, N) < c)) &&
          G(this, N, c),
        o.data
      ...
      throw R(this, Te, It).call(this, o);
    }
  }),
  (Te = new WeakSet()),
  (It = function (t) {
