  ...
  if ((t && typeof t == "object") || typeof t == "function")
    for (let s of vt(t))
      !$t.call(e, s) &&
        ...
        tt(e, s, {
          get: () => t[s],
          enumerable: !(n = Wt(t, s)) || n.enumerable,
        });
  return e;
};
var nt = (e, t, r) => (
...
function Nr(e, t, r) {
  ...
  let n = r.metaTokens,
    ...
    i = r.dots,
    o = r.indexes,
    l = (r.Blob || (typeof Blob < "u" && Blob)) && Cr(t);
  ...
  function m(f, y, k) {
    ...
    return Be(f) ? !0 : (t.append(gt(k, y, i), u(f)), !1);
  }
  let E = [],
    h = Object.assign(Ar, {
      defaultVisitor: m,
    ...
    return (
      ...
      l
        ...
        : ((!s[o] || !a.isObject(s[o])) && (s[o] = []),
          t(r, n, s[o], i) && a.isArray(s[o]) && (s[o] = kr(s[o])),
          !c)
    );
  }
...
Object.assign(v.prototype, {
  ...
  toJSON: function () {
    ...
    return (
      a.forEach(Object.assign({}, this[_t] || null, this), (t, r) => {
...
Object.assign(v, {
  ...
  accessor: function (e) {
    let r = (this[Ft] = this[Ft] = { accessors: {} }).accessors,
      n = this.prototype;
    function s(i) {
      let o = se(i);
      r[o] || (jr(n, i), (r[o] = !0));
  ...
  return new Promise(function (r, n) {
    ...
    s === void 0 && i.setContentType(null),
      ...
      typeof e.onDownloadProgress == "function" &&
        u.addEventListener("progress", Dt(e.onDownloadProgress, !0)),
      typeof e.onUploadProgress == "function" &&
        u.upload &&
        u.upload.addEventListener("progress", Dt(e.onUploadProgress)),
      (e.cancelToken || e.signal) &&
        ((c = (p) => {
          !u ||
            (n(!p || p.type ? new N(null, e, u) : p), u.abort(), (u = null));
        }),
...
var Qr = { "Content-Type": "application/x-www-form-urlencoded" };
function Hr() {
  let e;
  return (
...
var ve = { assertOptions: Jr, validators: We };
var $ = ve.validators,
  X = class {
    constructor(t) {
      (this.defaults = t),
        (this.interceptors = { request: new qe(), response: new qe() });
    }
    request(t, r) {
...
a.forEach(["delete", "get", "head", "options"], function (t) {
  X.prototype[t] = function (r, n) {
    return this.request(
      F(n || {}, { method: t, url: r, data: (n || {}).data })
    );
  };
});
a.forEach(["post", "put", "patch"], function (t) {
...
var ce = class {
    constructor(t) {
      ...
      this.promise.then((s) => {
        ...
        t(function (i, o, c) {
          n.reason || ((n.reason = new N(i, o, c)), r(n.reason));
        });
    }
    throwIfRequested() {
  ...
  Ye = class {
    constructor(t) {
      ...
      this.clientConfiguration = {
        ...Mr,
        ...t,
        secret: R(this, be, Ht).call(this, t),
      };
...
(P = new WeakMap()),
  ...
  (Ge = async function (t) {
    ...
    try {
      ...
      return (O(this, P) === void 0 || O(this, P) < o) && G(this, P, o), i.data;
    } catch (i) {
  ...
  (It = function (t) {
    return t.response
      ? t.response.data?.error
        ? R(this, Oe, Jt).call(this, t.response.data.error, t.response.status)
        : new M({ message: t.message, httpStatus: t.response.status })
      : t.request?.status === 0 ||
  ...
  (Jt = function (t, r) {
    return r === 401
      ...
      : r === 400 && t.code === "invalid_argument"
      ? new D({ httpStatus: r, ...t })
      : r === 400 && t.failures !== void 0
      ? new U({ httpStatus: r, ...t, failures: t.failures })
  ...
  (Ze = function (t, r) {
    ...
    r["x-last-txn"] === void 0 &&
      O(this, P) !== void 0 &&
      (r["x-last-txn"] = O(this, P).toISOString());
  });
var Vr = [
  "ECONNABORTED",
  "ECONNREFUSED",
...
var _,
  ...
  Y = class {
    ...
    toQuery(t = {}, r = 0) {
      return { ...R(this, Ne, Mt).call(this, r), ...t };
    }
  },
  Ce = Y;
(_ = new WeakMap()),
  ...
  (Ne = new WeakSet()),
  (Mt = function (t = 0) {
    if ("queryFragments" in O(this, _)) {
      let { queryFragments: r, queryArgs: n } = O(this, _),
        s = r[0];
      ...
      let r = `arg${t}`,
        n = {};
      return (n[r] = O(this, _).json), { query: `${r}`, arguments: n };
    }
  }),
  w(Ce, me);
export {
